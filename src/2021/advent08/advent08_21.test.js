const maxProfit = require('./advent08_21');

describe('Having advent`s challenge number 8', () => {
  test('#Test 01 - maximum profit is 16', () => {
  ...
  test('#Test 02 - maximum profit is 60', () => {
  ...
  test('#Test 03 - maximum profit is -1 (no profit at all)', () => {
  ...
  test('#Test 04 - maximum profit is -1 (no profit at all)', () => {
