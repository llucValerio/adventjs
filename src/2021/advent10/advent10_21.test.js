const getCoins = require('./advent10_21');

describe('Having advent`s challenge number 10', () => {
  test('#Test 01 - get minimum coins for 51', () => {
    const coins = 51;
  ...
  test('#Test 02 - get minimum coins for 3', () => {
    const coins = 3;
  ...
  test('#Test 03 - get minimum coins for 5', () => {
    const coins = 5;
  ...
  test('#Test 04 - get minimum coins for 16', () => {
    const coins = 16;
  ...
  test('#Test 05 - get minimum coins for 100', () => {
    const coins = 100;
