const canCarry = require('./advent21_21');
...
describe('Having advent`s challenge number 21', () => {
  ...
  // });
  test('#Test 01 - is the route ok for 3 presents', () => {
  ...
  test('#Test 02 - is the route ok for 3 presents', () => {
  ...
  test('#Test 03 - is the route ok for 4 presents', () => {
  ...
  test('#Test 04 - is the route ok for 1 presents', () => {
    const trip = [[2, 3, 8]];
